...
@section('contentPage')
    ...
    <div class="w-full">
        <img class="object-none w-full h-44" src="https://visitkent.com/wp-content/uploads/2017/10/ThinkstockPhotos-514369464.jpg" alt="comida">
    </div>
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <div class=" text-center">
            <h2 class=" w-full p-5 text-lg">Necesitamos expandir nuestra carta de comidas. <strong>Rellena este formulario</strong> con tu <strong>comida favorita</strong> y la añadiremos al Menú.</h2>
        </div>
